...
class MainWrapper extends StatelessWidget {
  ...
  final MainWrapperController _mainWrapperController = Get.find<
      MainWrapperController>(); //used to retrieve an instance of the MainWrapperController class
  @override
