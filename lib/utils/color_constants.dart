...
Color hexToColor(String hex) {
  assert(RegExp(r'^#([0-9a-fA-F]{6})|([0-9a-fA-F]{8})$').hasMatch(hex));//converts a hexadecimal color representation into a color object.
  //used to validate the input hex string.
